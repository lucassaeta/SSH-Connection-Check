...
if { [llength $argv] != 4 } {
    puts "ERROR: Error en la transmision de argumentos entre el script principal y el expect. Por favor, revise que los parametros son correctos"
    exit 1
}
